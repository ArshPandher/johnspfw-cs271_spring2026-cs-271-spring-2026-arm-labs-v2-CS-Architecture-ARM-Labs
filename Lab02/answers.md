...
- `op = 1` -> subtraction instead of addition  
- `S = 1` -> update condition flags  
...
- Do they match?
`0x1c - 12 = 0x10` -> **Yes, they match**

---

**NOT SOLVING THIS BECAUSE THE INSTRUCTOR TOLD TO NOT WORRY ABOUT THIS PART**
...
- SUBS XZR, X0, X1 (because CMP is just an alias for subtracting and discarding the result, while still updating the condition flags for branching.)
